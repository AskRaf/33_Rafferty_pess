...
$sql = "UPDATE 'incident' SET incident_status_id=3 WHERE patrolcar_id = '". $incidentId."'";
$updateSuccess = $conn->query($sql);
...
<div class="container" style="width:900px">
  ...
  ?>
  <section class="mt-3">
    <form action=" <form action= "<?php echo htmlentities($_SERVER["PHP_SELF"])
		?>" method ="post">
      ">
      <?php
      if ( $car != null ) {
        ...
        col - sm - 8 ">
			<span>
				" . $car[ "id" ] . "	
				 <input type=\"hidden\" id=\"patrolCarId\" name="
        patrolCarId " value=\"" . $car[ "id" ] . "\">
			</span>
        </div> 
      </div>
