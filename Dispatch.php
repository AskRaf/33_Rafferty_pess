...
<title>Dispatch Patrol Car</title>
...
?>
<section class="mt-3"> Main Content here...
  <form action= "<?php echo htmlentities($_SERVER["PHP_SELF"])
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-8"> <span> <?php echo $contactNo  ; ?>
        <input type="hidden"  id="contactNo" name="contactNo" value="91234567" <?php echo $contactNo; ?>">
        </span> </div>
    </div>
    <div class="form-group row">
      <label for="LocationOfIncident" class="col-sm-4 col-form-label">Location of incident</label>
      <div class="col-sm-8"> <span> <?php echo $LocationOfIncident; ?>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-8"> <span> <?php echo $TypeOfIncident; ?>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-8"> <span> <?php echo $DescriptionOfIncident; ?> <input name="DescriptionOfIncident"
					type="hidden"
